...
#checking for duplicate data and removing
...
#checking for duplicates of data  and removing the duplicates
dups <- duplicated(my_telco_data)
sum(dups)
my_telco_data <- my_telco_data[!dups , ]
str(my_telco_data)

#boxploting and checking for outliers
...
#installing pacakge to create dummies
...
#aggregating the data w.r.t clustering
